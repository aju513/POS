...
const SubCategory = () => {
  ...
  const getCategory = (pageNumber) => {
    axios
      .get(
        `${Constants.BASE_URL}/subCategory?page=${
  ...
  const handleCategoryDelete = (id) => {
    axios.delete(`${Constants.BASE_URL}/subCategory/${id}`).then((res) => {
  ...
  return (
    <>
      <Breadcrumb title={"SubCategory List"} />
      <div className="row">
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="card">
            <CardHeader title={"SubCategory List"} />
            <div className="card-body">
