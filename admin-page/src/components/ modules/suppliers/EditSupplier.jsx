...
const EditSupplier = () => {
  ...
  useEffect(() => {
    getProvinceData();
    getSupplierData();
    console.log(addressInput, input);
  }, []);

  const editSupplierOnClick = () => {
    axios
      .put(`${Constants.BASE_URL}/supplier/${params.id}`, [input, addressInput])
      .then((res) => {
        navigate("/supplier");
      })
      .catch((err) => {
                ...
                <div className="col-md-12">
                  <label htmlFor="" className="w-100">
                    ...
                    <select
                      ...
                      value={addressInput.province_id}
                      name="province_id"
